...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSArray * imgNames =[NSArray arrayWithObjects:@"jifen_self",@"record_of_conversion_self",@"huiyuan_self",@"yuyue",@"qianbao-0_self",@"yingshou",@"yaoqing",@"shiyongshuoming_self",@"set_self",@"guanyu_self", nil];
